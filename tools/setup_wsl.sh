...
export SOURCE_DIR="/mnt/c/99-Softs/confWSL"
export SETUP_DIR="/tmp/setup_wsl"
export USER_DIR="/mnt/c/Users/jhaumont"
export HELM_INSTALL_DIR="/home/jhaumont/bin"
export VAULT_VERSION="1.2.2"
export HELM_VERSION="v2.14.3"
export K9S_VERSION="0.8.4"
export DOCKER_COMPOSE_VERSION="1.24.1"
export AWS_AUTHENTICATOR_VERSION="0.4.0"
export KREW_VERSION="v0.3.0"
...
sudo apt install -y bash-completion man python3 python-pip python3-pip ssh netcat-openbsd bundler sl pandoc jq apt-transport-https curl git pkg-config ca-certificates gnupg2 software-properties-common wget
